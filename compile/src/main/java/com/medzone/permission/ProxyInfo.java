...
public class ProxyInfo {
    ...
    public static final String PROXY = PermissionProxy.class.getSimpleName();
    ...
    public String generateJavaCode() {
        ...
        builder.append("import com.medzone.permission.*;\n");
        builder.append('\n');

        builder.append("public class ").append(proxyClassName).append(" implements " + ProxyInfo.PROXY + "<").append(typeElement.getSimpleName()).append(">");
        builder.append(" {\n");
